...
[
  {
    ...
    "evidence": "azurechatopenai(model=model_choice, openai_api_type=os.getenv('api_type'), azure_endpoint=os.getenv('azure_oai_endpoint'), openai_api_key=os.getenv('azure_oai_key'), openai_api_version=os.getenv('api_version'), deployment_name=model_choice, temperature=temperature)"
  }
]
```
